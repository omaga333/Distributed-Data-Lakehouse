    ...
    create table "iceberg"."bronze_gold"."gold_customer_summary"
...
FROM "iceberg"."bronze_silver"."silver_customer_sessions" cs
LEFT JOIN "iceberg"."bronze_silver"."silver_payment_analysis" pa ON cs.customer_id = pa.customer_id
LEFT JOIN "iceberg"."bronze_silver"."silver_support_metrics" sm ON cs.customer_id = sm.customer_id
