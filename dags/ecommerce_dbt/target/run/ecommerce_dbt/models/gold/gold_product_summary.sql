    ...
    create table "iceberg"."bronze_gold"."gold_product_summary"
...
WITH product_events AS (
    ...
    FROM "iceberg"."bronze_bronze"."bronze_customer_events"
...
product_inventory AS (
    ...
    FROM "iceberg"."bronze_silver"."silver_inventory_health"
    GROUP BY product_id
)
