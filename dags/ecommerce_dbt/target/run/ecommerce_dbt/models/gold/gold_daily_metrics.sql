    ...
    create table "iceberg"."bronze_gold"."gold_daily_metrics"
...
WITH daily_sessions AS (
    ...
    FROM "iceberg"."bronze_silver"."silver_customer_sessions"
...
daily_payments AS (
    ...
    FROM "iceberg"."bronze_silver"."silver_payment_analysis"
...
daily_support AS (
    ...
    FROM "iceberg"."bronze_silver"."silver_support_metrics"
